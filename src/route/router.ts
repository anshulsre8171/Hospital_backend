...
import { addDepartmentController, getAppByAdmin, getAppGenByAdmin, getDepartmentController } from '../Contollers/AdminController/DepartmentController';
...
route.get('/get-genappointment-by-admin',verifyToken, getAppGenByAdmin);  // saare Gen appoinments 
